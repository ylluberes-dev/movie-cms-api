...
import com.ylluberes.moviestore.controller.response.MovieSearchResponse;
...
public class MovieController {
     ...
     */
    @PostMapping()
    public ResponseEntity<MovieResponse> register(@RequestBody @Valid final AddOrUpdateMovieRequest request) {
